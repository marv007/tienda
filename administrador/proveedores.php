    ...
    <form  method="post">
      <table class="table">
        ...
        while($reg=$sentencia->fetch_assoc()){
          echo "<tr>
                <td scope='col'><input type='checkbox' name='check_borrarcat[]' value='$reg[id_proveedor]'  id='customCheck1'></td>
        ...
        if(isset($_POST["borrar"])){
          ...
          {
            $sql_borrar ="delete from proveedor where id_proveedor = $cod_borrar";
